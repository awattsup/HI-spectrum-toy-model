...
gs  = gridspec.GridSpec(1, 1, wspace = 0,left = 0.14, right = 0.95, top=0.99, bottom = 0.14)
...
for ii in range(len(bases)):
	...
	AA_filename = f'{basedir}{base}AAVsm10.0_Afr1.00_rms/statistics/SN_Afr_statistics.fits'
...
plotdir = './figures/shapecompare_rms_AASN.png'
fig.savefig(plotdir)
