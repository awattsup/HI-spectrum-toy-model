...
bases = ['doublehorn','gaussian','tophat','narrow']
lines = ['-','--',':','-.']
...
for ii in range(len(bases)):
	...
	AA_filename = '{base}AAVsm10_Afr1.00_rms/statistics.dat'.format(base=base)
	...
	PN_filename = '{base}PNVsm10_Afr1.00_rms/statistics.dat'.format(base=base)
